			<div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
					...
					<li class="nav-item dropdown"><a
						...
						data-toggle="dropdown" aria-expanded="false"> <i
							class="mdi mdi-bell-outline"></i> <span class="count bg-danger">7</span>
					</a>
						<div
							class="dropdown-menu dropdown-menu-left navbar-dropdown preview-list pb-0"
						...
						<li
							...
							<div class="dropdown-menu dropdown-menu-left navbar-dropdown"
								...
								<div class="dropdown-header text-center">
									...
									<p class="mb-1 mt-3 font-weight-semibold">Mugwanya Nasser</p>
									<p class="font-weight-light text-muted mb-0">mugwanyan@gmail.com</p>
								</div>
								<a class="dropdown-item" href="profile">My Profile <span
